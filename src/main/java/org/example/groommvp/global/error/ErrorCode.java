...
public enum ErrorCode {
    ...
    ORDER_REFUND_REQUIRED(HttpStatus.CONFLICT, "결제 완료된 주문은 환불로 취소해주세요."),
    ...
    EMPTY_IMAGE_FILE(HttpStatus.BAD_REQUEST, "이미지 파일을 선택해주세요."),
    IMAGE_FILE_TOO_LARGE(HttpStatus.BAD_REQUEST, "이미지 크기는 5MB 이하여야 합니다."),
    INVALID_IMAGE_TYPE(HttpStatus.BAD_REQUEST, "JPG, PNG, WebP 이미지만 업로드할 수 있습니다."),
